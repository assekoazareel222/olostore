  ...
  return (
    <div className="w-full mt-10 text-2xl font-black gap-3  ">
      ...
      <div class=" flex mt-10 flex-wrap items-center justify-between w-[80%] m-auto py-1 md:py-2 gap-3 custom2:justify-around ">
        <div class="min-300:max-600:w-full bg-[#3883A2] p-3 rounded-[20px] text-center w-[400px] h-[450px] hover:scale-105 transition-transform duration-300 shadow-lg custom:w-[300px] custom:w-[400px] custom2:w-[300px] custom3:w-[250px] custom5:w-full">
        ...
        <div class="min-300:max-600:w-full bg-[#8EC0D4] p-3 rounded-[20px] text-center  w-[700px] h-[450px] hover:scale-105 transition-transform duration-300 shadow-lg min-300:max-600:w-[300px] custom:w-[700px] custom3:w-[500px] custom4:w-full custom5:w-full ">
          ...
          <div class="flex justify-start flex-col ml-8 small:ml-0">
            <p class="text-black w-[33%]  font-bold min-300:max-600:w-full">
              Ordinateur
            </p>
            <p class="text-white font-bold w-[33%]  text-lg min-300:max-600:w-[100%]">
              Mac book M1
            </p>
            <p class="custom3:w-full text-white text-xl mb-2 w-[33%] flex justify-around min-300:max-600:w-[100%] custom5:w-[50%]">
              500 0000{" "}
      ...
      <div className="w-full gap-3">
        <div class="gap-3 flex flex-wrap items-center justify-between w-[80%] m-auto py-1 md:py-2 ">
          <div class="min-300:max-600:w-full bg-[#B4B5B0] p-3 rounded-[20px] text-center w-[700px] h-[450px] hover:scale-105 transition-transform duration-300 shadow-lg  min-300:max-600:w-[300px] custom3:w-[500px] custom5:w-full custom4:w-full  ">
            ...
            <div class="flex justify-end mr-8 flex-col">
              ...
              <p class="custom3:w-full text-white text-xl mb-2  w-[30%] flex justify-around min-300:max-600:w-[100%] custom5:w-[50%]">
                430 000{" "}
          ...
          <div class="min-300:max-600:w-full bg-[#B4B5B0] p-3 rounded-[20px] text-center  w-[400px] h-[450px] hover:scale-105 transition-transform duration-300 shadow-lg custom:w-[300px] custom:w-[400px] custom2:w-[300px] custom3:w-[250px] custom5:w-full">
            <div class="flex items-center justify-center"> 
              <img
