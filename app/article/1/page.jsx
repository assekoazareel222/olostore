...
export default function Article() {
  ...
  return (
    <div className="flex  flex-col min-h-screen"> {/* Utilisez min-h-screen pour occuper toute la hauteur de l'écran */}
      <Header />

      <div
        className="w-[80%] m-auto md:mt-1 lg:mt-3  bg-[#E9F2F2] border rounded-2xl md:mb-1 lg:mb-3 mb-8 lg:pr-20 lg:pl-10 md:flex md:justify-around max-sm:justify-center max-sm:items-center md:pl-10"
      ...
      {/* Le footer sera toujours en bas grâce à min-h-screen et flex */}
      <Footer />
    </div>
  );
}
