...
export default function Article() {
  ...
  return (
    <div className="w-full h-screen flex flex-col">
      ...
      <div
        className="w-[80%] m-auto mt-2 md:mt-1 lg:mt-3 max-lg:flex-col max-lg:items-center py-8 bg-[#E9F2F2] border rounded-2xl md:mb-1 lg:mb-3 mb-8 lg:pr-20 lg:pl-10  md:flex md:justify-around   max-sm:justify-center max-sm:items-center md:pl-10"
      ...
      >
        ...
        <div className="w-[50%] h-[50%]  flex flex-col justify-center items-center">
          <div className=" flex flex-col relative items-start justify-center items-center">
            <div className="w-full flex justify-center items-center">
              <Image
                className="  bg-cover max-md:w-200px  lg:w-[400px] lg:h-[300px] "
        ...
        {/* deuxième */}
        <div className="w-[50%]  flex flex-col gap-4 max-sm:m-auto border-x-2 max-sm:mt-4 border-y-2 rounded-lg px-4 py-4 md:px-1 md:pl-2 md:pr-2 max-lg:w-[70%]  border-[#076389] ">
          <div>
